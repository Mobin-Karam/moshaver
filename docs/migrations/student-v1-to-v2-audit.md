...
The database migration is separate from the client rewrite. Use read-only export from the v1 database and import into a fresh v2 database, as described in the [backend v1-to-v2 strategy](./backend-v1-to-v2-strategy.md).
...
1. Treat the [Student v2 parity gaps](./student-v2-parity-gaps.md) and [Student v2 delivery plan](./student-v2-delivery-plan.md) as supporting plans; this document is the current migration decision record.
