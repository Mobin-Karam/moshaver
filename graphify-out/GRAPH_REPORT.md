...
## Summary
- 5664 nodes · 15343 edges · 310 communities (200 shown, 71 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 657 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d0c9eff8`
...
- `MonthPicker()` --calls--> `cn()`  [EXTRACTED]
  admin-v2/src/shared/ui/date-picker.tsx → admin-v2/src/shared/lib/utils.ts
- `StudentAvatar()` --calls--> `cn()`  [EXTRACTED]
  admin-v2/src/shared/ui/StudentPicker.tsx → admin-v2/src/shared/lib/utils.ts
...
## Communities (310 total, 71 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (83): auth, notifications, AttentionInbox(), Filter, reasonIcons, severityTone(), DashboardFollowUpCard(), icons (+75 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (90): DailyReport, Column, CreateDateColumn, Entity, Index, ManyToOne, PrimaryGeneratedColumn, UpdateDateColumn (+82 more)
...
Cohesion: 0.05
Nodes (72): deletePushSubscription(), getAdvisorInbox(), getNotificationsPage(), getPushConfig(), getPushStatusRemote(), markAllNotificationsRead(), markNotificationRead(), registerPushSubscription() (+64 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (80): Organization, OrganizationStatus, ACTIVE, ARCHIVED, INACTIVE, Column, CreateDateColumn, Entity (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (73): createPlan(), deletePlan(), deletePlannerTask(), duplicatePlan(), getPlanForDate(), getPlannerExams(), getPlans(), movePlannerTask() (+65 more)
...
Cohesion: 0.06
Nodes (67): archiveStudent(), createStudent(), createStudentRecommendation(), getStudentAnalytics(), getStudentAttempts(), getStudentLearning(), getStudentMistakes(), getStudentOverview() (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (66): Plan, PlanStatus, ARCHIVED, DRAFT, PUBLISHED, Column, CreateDateColumn, Entity (+58 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (58): message(), queryClient, SettingsPage, ChatHeader(), jumpToMessage(), changePassword(), getSessions(), revokeSession() (+50 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (49): ExamsPage, addExamSyllabus(), createExam(), deleteExam(), deleteExamSyllabus(), getExamAttemptDetail(), getExamAttemptHistory(), getExams() (+41 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (31): LearningReview, Column, CreateDateColumn, Entity, ManyToOne, PrimaryGeneratedColumn, RecoveryRequest, Column (+23 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (8): ApiException, AssessmentsService, Injectable, UserContext, ImportExportService, Injectable, SubjectsService, Injectable

### Community 14 - "Community 14"
Cohesion: 0.10
Nodes (22): CAPABILITIES_KEY, ROLES_KEY, mutating, UserRole, ADMIN, ADVISOR, CONTENT_MANAGER, GUARDIAN (+14 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (49): HttpExceptionFilter, CapabilitiesGuard, Injectable, RolesGuard, Injectable, LoggingInterceptor, Injectable, localCorsOrigins (+41 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (46): adminBreadcrumbs(), adminDestination(), adminNavigation, flatAdminNavigation, mainAdminNavigation, mainNavigationForCapabilities(), navigationForCapabilities(), normalizeAdminPath() (+38 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (47): allRoles, errorText(), nameOf(), OrganizationsPage(), organizationTypes, statusLabels, UsersPage(), acceptRelationship() (+39 more)
...
Cohesion: 0.10
Nodes (36): createExamQuestion(), deleteExamQuestion(), getExamQuestions(), getStudentExams(), updateQuestion(), QuestionEditor(), QuestionsList(), emptyQuestion() (+28 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (55): ChatConfiguration, Column, Entity, PrimaryColumn, UpdateDateColumn, ChatMessage, ChatMessageType, EXAM (+47 more)
...
Cohesion: 0.10
Nodes (11): Roles(), CreateQuestionDto, ExamsController, Body, Controller, Delete, Get, Param (+3 more)
...
Cohesion: 0.06
Nodes (45): ExamAssignment, CreateDateColumn, Entity, Index, ManyToOne, PrimaryGeneratedColumn, ExamAttempt, Column (+37 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (18): AuthSessionGuard, Injectable, CsrfGuard, Injectable, AuthController, Body, Controller, Delete (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (41): dir, RecoveryRequestStatus, DISMISSED, PENDING, RESOLVED, StudySessionStatus, ACTIVE, FINISHED (+33 more)
...
Cohesion: 0.10
Nodes (19): RequireCapabilities(), StudentAdministrationController, Body, Controller, Delete, Get, Param, Patch (+11 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (30): SignupThrottle, Column, Entity, Index, PrimaryGeneratedColumn, UpdateDateColumn, OnboardingController, Body (+22 more)
...
Cohesion: 0.09
Nodes (3): ChatService, emptyStudentProfile(), Injectable
...
Cohesion: 0.05
Nodes (44): ExamRetryRequest, Column, CreateDateColumn, Entity, Index, ManyToOne, PrimaryGeneratedColumn, UpdateDateColumn (+36 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (37): ChangePasswordDto, IsString, MaxLength, MinLength, LoginDto, IsString, MaxLength, MinLength (+29 more)
...
Cohesion: 0.09
Nodes (27): DevBackendSwitcher(), labelFor(), options, api, ApiEnvelope, AuthFailureListener, authFailureListeners, BackendTarget (+19 more)
...
Cohesion: 0.12
Nodes (18): CurrentUser, AssessmentsController, Body, Controller, Delete, Get, Param, Patch (+10 more)

### Community 42 - "Community 42"
Cohesion: 0.09
Nodes (11): LearningItem, Column, CreateDateColumn, Entity, Index, ManyToOne, OneToMany, PrimaryGeneratedColumn (+3 more)

### Community 43 - "Community 43"
Cohesion: 0.09
Nodes (22): RelaxationAdminController, RelaxationStudentController, Body, Controller, Get, Param, Patch, Post (+14 more)

### Community 44 - "Community 44"
Cohesion: 0.16
Nodes (11): ok(), ChatController, Body, Controller, Delete, Get, Param, Patch (+3 more)
...
Cohesion: 0.10
Nodes (23): PortalOrganization, PortalUser, ConversationList(), conversationLabel(), ConversationListItem(), studentAffiliation(), StudentAssignmentForm(), ConversationSkeleton() (+15 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (31): LearningStatus, ARCHIVED, DONE, PENDING, CreateLearningItemDto, ReviewLearningItemDto, IsEnum, IsNumber (+23 more)
...
Cohesion: 0.08
Nodes (19): can, CapabilityRoute(), ChatPage, DashboardPage, FollowUpPage, LearningPage, LivePage, NotificationsPage (+11 more)

### Community 53 - "Community 53"
Cohesion: 0.14
Nodes (17): WireChatMessage, CreateGroupButton(), CreateGroupForm(), GroupInfoButton(), GroupManager(), GroupMeta(), MemberRow(), PermissionEditor() (+9 more)
...
Cohesion: 0.13
Nodes (8): SystemController, Body, Controller, Get, Param, Put, SystemService, Injectable
...
Cohesion: 0.14
Nodes (22): normalizeChatMessage(), ConversationSidebar(), MessageSearchBar(), useChatSelectionParams(), useConversation(), useMessageActions(), toFa(), draftKey() (+14 more)
...
Cohesion: 0.14
Nodes (19): fetchConversationPage(), ConversationSearch(), filters, ConversationToolbar(), sorts, initialCursor, useConversations(), chatSearchMatch() (+11 more)
...
Cohesion: 0.14
Nodes (15): LearningHeader(), StudentPickerProps, QuestionsSelector(), TriggerProps, ViewportPopover(), ViewportPopoverProps, Filter, hasAttention() (+7 more)
...
Cohesion: 0.10
Nodes (19): description, engines, node, moshaver, installModel, workspaceGraph, name, private (+11 more)
...
Cohesion: 0.15
Nodes (10): StudentPresence, Column, Entity, JoinColumn, OneToOne, PrimaryGeneratedColumn, UpdateDateColumn, ActivityService (+2 more)
...
Cohesion: 0.15
Nodes (8): RealtimeController, Controller, RealtimeModule, Module, RealtimeEvent, RealtimeService, Injectable, Sse
...
Cohesion: 0.16
Nodes (6): StaffMistakesController, Controller, MistakesService, Injectable, InjectRepository, Optional
...
Cohesion: 0.22
Nodes (8): ReportsController, Body, Controller, Get, Param, Patch, Post, Query
...
Cohesion: 0.16
Nodes (7): RecommendationStatus, ACCEPTED, DISMISSED, PROPOSED, REJECTED, AnalyticsService, Injectable
...
Cohesion: 0.14
Nodes (11): SyncChangeDto, IsIn, IsOptional, IsString, MaxLength, SyncController, Body, Controller (+3 more)
...
Cohesion: 0.31
Nodes (11): AssignTeacherSubjectDto, CreateSubjectDto, IsBoolean, IsInt, IsOptional, IsString, IsUUID, Length (+3 more)
...
Cohesion: 0.23
Nodes (6): chatApi, fetchMessages(), normalizeMessagePage(), chatKeys, useMessages(), SendMessageInput

### Community 129 - "Community 129"
Cohesion: 0.27
Nodes (6): MistakesController, Body, Get, Param, Patch, Query
...
Cohesion: 0.24
Nodes (7): CreateTaskCommentDto, IsString, Length, CreateTaskIssueDto, IsOptional, IsString, Length
...
Cohesion: 0.22
Nodes (8): Recommendation, Column, CreateDateColumn, Entity, Index, ManyToOne, PrimaryGeneratedColumn, InjectRepository
...
Cohesion: 0.25
Nodes (7): LoginThrottle, Column, Entity, Index, PrimaryGeneratedColumn, UpdateDateColumn, InjectRepository
...
Cohesion: 0.29
Nodes (7): ActivityEvent, Column, CreateDateColumn, Entity, Index, ManyToOne, PrimaryGeneratedColumn

### Community 174 - "Community 174"
Cohesion: 0.33
Nodes (4): TaskCompletionStatus, DONE, PARTIAL, SKIPPED
...
Cohesion: 0.33
Nodes (6): ImportHistory, Column, CreateDateColumn, Entity, ManyToOne, PrimaryGeneratedColumn
...
Cohesion: 0.50
Nodes (3): icons, InsightValue, StudentInsights()
...
## Knowledge Gaps
- **918 isolated node(s):** `Filter`, `Metric`, `Metric`, `AttentionPresence`, `RoleQuickAction` (+913 more)
...
- **Why does `@tanstack/react-query` connect `Community 10` to `Community 128`, `Community 0`, `Community 4`, `Community 6`, `Community 8`, `Community 11`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 29`, `Community 38`, `Community 39`, `Community 48`, `Community 49`, `Community 53`, `Community 62`, `Community 67`, `Community 69`, `Community 99`, `Community 120`?**
  _High betweenness centrality (0.272) - this node is a cross-community bridge._
- **Why does `typescript` connect `Community 95` to `Community 29`, `Community 55`?**
  _High betweenness centrality (0.181) - this node is a cross-community bridge._
- **Why does `@types/node` connect `Community 55` to `Community 29`?**
...
- **What connects `Filter`, `Metric`, `Metric` to the rest of the system?**
  _918 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.03635955560543149 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02465564738292011 - nodes in this community are weakly interconnected._