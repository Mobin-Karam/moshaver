...
var SHELL=['./','./index.html','./css/app.css?v=__APP_VERSION__','./js/api.js?v=__APP_VERSION__','./js/update.js?v=__APP_VERSION__','./js/app.js?v=__APP_VERSION__','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/logo.svg','./icons/svg/today.svg','./icons/svg/schedule.svg','./icons/svg/exams.svg','./icons/svg/progress.svg','./icons/svg/more.svg','./icons/svg/study.svg','./icons/svg/quiz.svg','./icons/svg/review.svg'];
