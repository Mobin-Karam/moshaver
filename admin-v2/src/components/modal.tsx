    ...
    >
      ...
      >
        <header className="flex items-start gap-4 border-b border-slate-200 px-5 py-4">
          ...
          {dismissible ? (
            <button
              ...
              className="grid size-9 shrink-0 place-items-center rounded-md text-slate-500 hover:bg-slate-100 hover:text-ink"
            >
              <X size={19} />
            </button>
          ) : null}
        ...
        {modal.showCancel || modal.confirmLabel || modal.onConfirm ? (
          <footer className="flex flex-wrap justify-end gap-2 border-t border-slate-200 bg-slate-50/70 px-5 py-4">
            {modal.showCancel ? (
