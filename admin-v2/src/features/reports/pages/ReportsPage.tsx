...
export function ReportsPage() {
  ...
  return <div className="grid gap-5">
    <div className="flex justify-end"><div className="grid gap-2 md:grid-cols-3"><StudentPicker students={students.students} value={students.studentId} onChange={students.setStudentId} /><DatePicker value={from} max={to} onChange={setFrom} /><DatePicker value={to} min={from} onChange={setTo} /></div></div>
