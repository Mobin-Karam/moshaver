...
export const createExamQuestion = (examId: string, body: QuestionDraft) =>
  api.post(`/exams/${examId}/questions`, body);
export const updateQuestion = (id: string, body: QuestionDraft) =>
  api.patch(`/questions/${id}`, body);
export const deleteExamQuestion = (examId: string, id: string) =>
  api.delete(`/exams/${examId}/questions/${id}`);
