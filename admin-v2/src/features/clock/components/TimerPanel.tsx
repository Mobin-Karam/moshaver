...
export function TimerPanel() {
  ...
  return (
    <div className="space-y-4">
      <div
        className={`rounded-2xl px-3 py-5 text-center ${timer.status === "finished" ? "bg-rose-50 dark:bg-rose-950/20" : "bg-slate-50 dark:bg-slate-950/45"}`}
      >
        <div
          dir="ltr"
          className={`font-mono text-4xl font-black tabular-nums tracking-widest ${timer.status === "finished" ? "text-rose-600 dark:text-rose-400" : "text-slate-900 dark:text-white"}`}
        >
