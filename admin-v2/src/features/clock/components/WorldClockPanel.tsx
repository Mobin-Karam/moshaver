    ...
    <div className="space-y-3">
      ...
      <div className="max-h-64 space-y-2 overflow-y-auto pr-0.5">
        {items.map((item) => (
          <div
            key={item.id}
            className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800/70"
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div dir="ltr" className="truncate text-[9px] text-slate-400">
                {item.timeZone}
              </div>
            </div>
            <div className="text-left">
              ...
              >
                {formatClockTime(now, false, item.timeZone)}
              </strong>
              <span className="text-[9px] text-slate-400">
                {getDayOffsetLabel(now, item.timeZone)}
              </span>
            </div>
            <button
              type="button"
