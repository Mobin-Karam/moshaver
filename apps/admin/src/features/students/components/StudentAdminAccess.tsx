    ...
    <section className="grid gap-3" aria-labelledby="student-access-heading">
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
          شناسه دانش‌آموز در مقصد حفظ می‌شود.
        </p>
      </div>
