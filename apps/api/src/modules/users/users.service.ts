...
export class UsersService {
  ...
  private assertRoles(actor: AuthenticatedUser, roles: string[]) { if (!this.tenancy.canAssignRoles(actor, roles)) throw new ApiException(403,"ROLE_ESCALATION","تخصیص مدیر پلتفرم مجاز نیست."); }
