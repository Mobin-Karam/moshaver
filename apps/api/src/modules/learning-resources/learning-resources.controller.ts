...
export class LearningResourcesController {
  ...
  @Get("assignable-students") @RequireCapabilities("learning_resources.manage") assignableStudents(@CurrentUser() user: AuthenticatedUser) { return this.service.listAssignableStudents(user).then(ok); }
