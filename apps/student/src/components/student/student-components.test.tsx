...
const studentAccess: PortalAccess = { mode: 'student', canMutateStudentWork: true, canReadDashboard: true, canTakeExams: true, canReadPlans: true, canReadExams: true, canReadLearning: true, canCreateLearning: true, canUpdateLearning: true, canReviewLearning: true, canReadResources: true, canShareEducation: true, canUseQuizzes: true, canReadSubjects: true, canReadGuardianStudents: false, canUseChat: true, navigation: ['today', 'plan', 'exams', 'chat', 'more'] };
