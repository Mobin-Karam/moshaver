...
[
 'openModal','closeModal','openImport','openAdminNotifications','openPlanForm','openTaskForm','publishRange','loadExams','openExamForm','openExamQuestions','loadExamRetryRequests','reviewExamRetry','previewImport','commitImport','sendAdminChat','boot'
...
assert(aj.includes("DOMContentLoaded',init")&&aj.includes('else init();'),'Admin must initialize on DOM ready');
