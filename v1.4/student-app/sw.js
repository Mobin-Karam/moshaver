...
var SHELL=['./','./index.html','./css/app.css?v=1.4.2','./js/api.js?v=1.4.2','./js/update.js?v=1.4.2','./js/app.js?v=1.4.2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/logo.svg','./icons/svg/today.svg','./icons/svg/schedule.svg','./icons/svg/exams.svg','./icons/svg/progress.svg','./icons/svg/more.svg','./icons/svg/study.svg','./icons/svg/quiz.svg','./icons/svg/review.svg'];
