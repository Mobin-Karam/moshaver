...
var CSRF_KEY='moshaver_student_csrf';
...
function openEvents(onEvent,onState){
  ...
  var names=['chat.message.created','chat.messages.read','plan.published','plan.updated','advisor.comment.created','notification.created','review.created','exam.retry_reviewed','exam.updated'];
